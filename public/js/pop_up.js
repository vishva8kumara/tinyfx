...
else{setTimeout("popup_bring_up('"+Id+"', "+Opacity+" + 20);",40);if(!ScrollingTimeout)
scroll_to_top();}}
...
document.onscroll=function(){if(programmetic_scrolling)
return false;clearTimeout(ScrollingTimeout);ScrollingTimeout=false;}
...
else{setTimeout("popup_bring_down('"+Id+"', "+Opacity+" - 20);",50);}}
document.onkeyup=function(e){if(!e)e=window.event;if((e.keyCode&&e.keyCode=="27")||(e.charCode&&e.charCode=="27")){var popups=document.getElementById('popup_space').childNodes;if(popups.length>0){var last_popup=popups[popups.length-1];popup_bring_down(last_popup.id,100);}}
if(typeof document_onkeyup=='function'){document_onkeyup(e.keyCode?e.keyCode:e.charCode);}}
